...
const getAllStudyLessons = catchAsync(async (req: Request, res: Response) => {
     ...
     sendResponse<{ meta: { total: number; page: number; limit: number; }; result: IStudyLesson[]; }>(res, {
          statusCode: 200,
          success: true,
...
const getAllUnpaginatedStudyLessons = catchAsync(async (req: Request, res: Response) => {
...
const hardDeleteStudyLesson = catchAsync(async (req: Request, res: Response) => {
     const { id } = req.params;

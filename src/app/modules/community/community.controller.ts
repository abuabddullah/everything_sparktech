...
const createCommunity = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await CommunityServices.createCommunity(user, communityData)
...
const updateCommunity = catchAsync(async (req: Request, res: Response) => {
  ...
  const communityData = req.body
  const user = req.user
  const result = await CommunityServices.updateCommunity(
    id,
    user,
    communityData,
  )
...
const getAllCommunitys = catchAsync(async (req: Request, res: Response) => {
  const result = await CommunityServices.getAllCommunitys(req.user!, req.query)
...
const addAnswer = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await CommunityServices.addAnswer(
    communityId,
    user,
    answerData,
  )
...
const deleteAnswer = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await CommunityServices.deleteAnswer(
    communityId,
    answerId,
    user,
  )
...
const updateAnswer = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await CommunityServices.updateAnswer(
    communityId,
    answerId,
    user,
    answerData,

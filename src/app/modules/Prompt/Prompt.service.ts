...
const getAllPrompts = async (query: Record<string, any>): Promise<{ meta: { total: number; page: number; limit: number; }; result: IPrompt[]; }> => {
...
const updatePrompt = async (id: string, payload: Partial<IPrompt>): Promise<IPrompt | null> => {

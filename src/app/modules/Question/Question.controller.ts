...
const getAllQuestions = catchAsync(async (req: Request, res: Response) => {
     ...
     sendResponse<{ meta: { total: number; page: number; limit: number; }; result: IQuestion[]; }>(res, {
          statusCode: 200,
          success: true,
...
const getAllUnpaginatedQuestions = catchAsync(async (req: Request, res: Response) => {

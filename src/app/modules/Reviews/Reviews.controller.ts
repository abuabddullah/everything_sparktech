...
const getAllReviewsByType = catchAsync(async (req: Request, res: Response) => {
  const result = await ReviewsService.getAllReviewsByTypes(
    req.params.type,
    req.query,
  )
...
const getAllUnpaginatedReviewsByType = catchAsync(
  async (req: Request, res: Response) => {
    const result = await ReviewsService.getAllUnpaginatedReviewsByType(
      req.params.type,
    )

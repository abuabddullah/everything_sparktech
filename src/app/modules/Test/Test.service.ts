...
const getAllTests = async (query: Record<string, any>): Promise<{ meta: { total: number; page: number; limit: number; }; result: ITest[]; }> => {
...
const updateTest = async (id: string, payload: Partial<ITest>): Promise<ITest | null> => {

...
const { getLocationNameSuggestions, getLocationPoints, getDistanceBetweenTwoLocations } = require('./map.service');
...
const getLocationSuggestions = catchAsync(async (req, res) => {
  ...
  return res.status(httpStatus.OK).json(response({ message: "Messages", status: "OK", statusCode: httpStatus.OK, data }));
});
...
module.exports = { getLocationSuggestions, getLocationCoordinates, getDistance };
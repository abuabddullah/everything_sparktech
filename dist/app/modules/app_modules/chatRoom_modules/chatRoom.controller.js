...
const createChat = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const participants = [user === null || user === void 0 ? void 0 : user.id, ...recieverParticipants];
    const chat = yield chatRoom_service_1.ChatService.createChatToDB(participants);
...
const getChat = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const chatList = yield chatRoom_service_1.ChatService.getChatFromDB(user, search);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,

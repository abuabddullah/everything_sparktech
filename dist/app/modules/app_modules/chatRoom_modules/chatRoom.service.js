...
const message_model_1 = require("../message_modules/message.model");
const chatRoom_model_1 = require("./chatRoom.model");
const createChatToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExistChat = yield chatRoom_model_1.Chat.findOne({
        participants: { $all: payload },
    });
    if (isExistChat) {
        return isExistChat;
    }
    const chat = yield chatRoom_model_1.Chat.create({ participants: payload });
    return chat;
});
const getChatFromDB = (user, search) => __awaiter(void 0, void 0, void 0, function* () {
    const chats = yield chatRoom_model_1.Chat.find({ participants: { $in: [user.id] } })
        .populate({
        path: 'participants',

...
const vehicle_model_1 = require("../app_modules/vehicle_modules/vehicle.model");
...
userSchema.methods.getVehicle = function () {
    return __awaiter(this, void 0, void 0, function* () {
        if (this.role !== user_1.USER_ROLES.DRIVER || !this.licenseNumber) {
            return null;
        }
        const vehicle = yield vehicle_model_1.Vehicle.findOne({ licenseNumber: this.licenseNumber });
        return vehicle;
    });
};
//exist user check
